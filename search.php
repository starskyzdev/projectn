        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="font-family: 'Indie Flower', cursive;">
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="main.php">Your Quotes Of
                            TheDay</a></li>
        ...
        <div class="container">
            <div class="row align-items-start">
                ...
                <div class="col-md-8" style="font-family:'Indie Flower', cursive;">
                    <h2 style="color: #FFDA03;">CrAwling SearCh</h2>
                    <br>
                ...
                <div class=" input-group">
                                <input type="search" class="form-control rounded" placeholder="Search quotes only"
                                    aria-label="Search" aria-describedby="search-addon" />
                                <button type="button" class="btn btn-outline-info"
                                    style="color: #FF3D00;">search</button>
                        </div>
                        <br>
                        <footer class=" text-center">this website is a<cite title="Source Title"
                                style="font-family: 'Ribeye Marrow', cursive;"> cake</cite></footer>
                        </blockquote>
                        <br>
                    </div>
                </div>
